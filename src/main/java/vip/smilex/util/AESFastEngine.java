    ...
    */
    ...
    private int[][] generateWorkingKey(byte[] key, boolean forEncryption)
    {
        ...
        switch (KC)
        {
            case 4:
            {
                int t0 = Utils.littleEndianToInt(key,  0); W[0][0] = t0;
                int t1 = Utils.littleEndianToInt(key,  4); W[0][1] = t1;
                int t2 = Utils.littleEndianToInt(key,  8); W[0][2] = t2;
                int t3 = Utils.littleEndianToInt(key, 12); W[0][3] = t3;
            ...
            case 6:
            {
                ...
                int t2 = Utils.littleEndianToInt(key,  8); W[0][2] = t2;
                int t3 = Utils.littleEndianToInt(key, 12); W[0][3] = t3;
                int t4 = Utils.littleEndianToInt(key, 16); W[1][0] = t4;
                int t5 = Utils.littleEndianToInt(key, 20); W[1][1] = t5;
            ...
            case 8:
            {
                ...
                int t4 = Utils.littleEndianToInt(key, 16); W[1][0] = t4;
                int t5 = Utils.littleEndianToInt(key, 20); W[1][1] = t5;
                int t6 = Utils.littleEndianToInt(key, 24); W[1][2] = t6;
                int t7 = Utils.littleEndianToInt(key, 28); W[1][3] = t7;
    ...
    {
        this.C0 = Utils.littleEndianToInt(bytes, off);
        this.C1 = Utils.littleEndianToInt(bytes, off + 4);
        this.C2 = Utils.littleEndianToInt(bytes, off + 8);
        this.C3 = Utils.littleEndianToInt(bytes, off + 12);
    }

    private void packBlock(byte[] bytes, int off)
    {
        Utils.intToLittleEndian(this.C0, bytes, off);
        Utils.intToLittleEndian(this.C1, bytes, off + 4);
        Utils.intToLittleEndian(this.C2, bytes, off + 8);
        Utils.intToLittleEndian(this.C3, bytes, off + 12);
    }
